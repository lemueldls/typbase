...
const $nsid = "app.typbase.update";

type $nsid = typeof $nsid;

export { $nsid };

/** One exported Loro update for one document. rkey is the Loro version vector encoded as a TID-safe base32 string, so concurrent writers get unique rkeys. */
type Main = {
  $type: "app.typbase.update";

  /**
   * Loro document id (workspace id or page id).
   */
  docId: string;
  ...
  /**
   * Version vector JSON of the exported update, used for merge buffering.
   */
  version: string;
